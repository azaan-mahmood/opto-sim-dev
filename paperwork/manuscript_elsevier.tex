...
parameter to apply either model at any distance.
...
\operatorname{Exp}(1)$ after the dead time expires.
...
specifications without adjustable parameters.  The systematic
$\sim$0.9~pp undershoot across all short-distance points is consistent
with uncharacterised environmental noise in the experimental setup
(ambient background, detector timing jitter, electrical pickup) that is
absent from the simulation.  Despite this offset, the QBER curve
