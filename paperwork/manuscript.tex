...
against published literature (34~sources).
...
under combined impairments.  The framework is designed to enable
defensible studies of environmental sensitivity and physical-layer
security that existing QKD simulators, which operate at the qubit or
photon-count level, cannot support.
