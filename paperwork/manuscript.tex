...
\begin{table}[!ht]
  \caption{PMD validation results.}
  \label{tab:pmd}
  \centering
  \begin{tabular}{l c c c}
    ...
    \midrule
    Mean DGD (ps) & 29.21 & 29.14 & 0.3\% \\
    RMS DGD (ps)  & 31.73 & 31.62 & 0.3\% \\
    KS $p$-value  & 0.42  & ---   & $>$0.05 \\
    \bottomrule
  \end{tabular}
\end{table}
...
checks in Panel~F pass, including power conservation (unitary Jones
...
\begin{figure}[!ht]
  ...
  ($\bar{n} = Pt\eta/h\nu$, Saleh and Teich Eq.~17.1-10).  F: Summary.}
  \label{fig:apd}
\end{figure}
...
BB84 systems~\cite{takesue,dixon}.  Six panels (Fig.~\ref{fig:system})
...
\begin{figure}[!ht]
  ...
  F: Summary table of combined impairment scenarios at 100~km.}
  \label{fig:system}
\end{figure}
...
\paragraph{Panel F: Combined impairment scenarios.}
...
The six panels together confirm that the independently validated
