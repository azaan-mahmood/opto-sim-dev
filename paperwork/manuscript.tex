...
decoding with $\cos^2(\Delta\phi/2)$ interference (Townsend~1993);
...
(vi)~a Geiger-mode single-photon avalanche diode (SPAD) with dead time,
...
correctly: a five-panel BB84 sweep under combined impairments and a
  time-bin BB84 validation matching Gobby's QBER vs distance (0~km~QBER~
  2.43\% vs paper~3.3\%).  The framework is fully reproducible (seeded RNG,
version-controlled, 77~unit tests passing) and available at
...
Comput. Syst. Signal Process.}, 1984, pp.~175--179.  \hfill
...
\textit{Electron. Lett.}, vol.~29, no.~7, pp.~634--635, 1993.  \hfill
(First time-bin interferometry for QKD.)

\bibitem{id230}
ID~Quantique, ``ID230 InGaAs SPAD datasheet,'' 2020.  \hfill
(Dead time 13~$\mu$s, $\eta$~10\%, DCR~15~Hz, afterpulse~5\%.)
