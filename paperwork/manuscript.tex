...
(L $<$ 2~km) where the detailed polarisation evolution matters,
but becomes computationally expensive at long-haul distances and
converges to a uniform SU(2) distribution within approximately
1~km regardless of parameters.  For long-haul BB84 simulation
(L $\ge$ 2~km) we therefore replace the ordered product with a
single SU(2) rotation whose angle follows the phenomenological
$\sqrt{L}$ law (Menyuk~\&~Wai~1994):
