...
def run_to_target(config, target_sifted, ceiling, seed,
    ...
    Timing note: `simulate_point` measures ~35.8 us/pulse -- this is the
    SPAD Monte Carlo, *not* the ~10 us/pulse Gobby chain (whose PERF-2
    8-outcome table does not apply here).  Budget 3.6x accordingly.
    """
...
def main():
    ...
    parser.add_argument('--target-sifted', type=int, default=None,
                        ...
                        help=f'Grow the pulse count per row until N sifted '
                             ...
                             f'~35.8 us/pulse, 3.6x the Gobby chain -- budget '
